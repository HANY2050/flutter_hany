...
import 'package:generalshops/orderAsk/order1.dart';
import 'package:generalshops/orderAsk/order2.dart';
import 'package:generalshops/screens/utilities/size_config.dart';
import 'package:pull_to_refresh/pull_to_refresh.dart';

import '../animaterout.dart';

class OrderAskTransfer2 extends StatefulWidget {
  //const OrderAskTransfer2({Key? key}) : super(key: key);
  final Cart cart;
  OrderAskTransfer2(this.cart);
  @override
  _OrderAskTransfer2State createState() => _OrderAskTransfer2State();
}

class _OrderAskTransfer2State extends State<OrderAskTransfer2> {
  ...
  void _gotoSingleProduct(Cart cart, BuildContext context) {
    Navigator.of(context).push(SlideRight(Page: Order1(cart)));
  }

  void _gotoSingleProducts(Cart cart, BuildContext context) {
    Navigator.of(context).push(SlideRight(Page: Order2(cart)));
  }
}
